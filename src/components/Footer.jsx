    ...
    <footer className="relative bg-black">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 pt-12 pb-8 border-t border-purple-900/50 text-center relative">
          ...
          <p className="relative font-['Precious'] text-2xl md:text-3xl text-white/90 leading-relaxed px-4 py-2">
            "In Every Market Moment Lies an Opportunity."
          </p>
          <p className="relative font-['Precious'] text-xl text-purple-300/80 mt-5 mb-12">
            - The Codify Ai team -
          </p>
