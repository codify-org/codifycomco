...
const HeroSection = () => {
  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 overflow-hidden section-transition">
      ...
      <div className="absolute inset-0">
        <video
          ...
          preload="auto"
          aria-label="Background animation showing market data visualization"
        >
      ...
      <div className="relative max-w-7xl mx-auto section-transition-content" style={{ zIndex: 10 }}>
        <div className="space-y-12 text-center">
          ...
          <button 
            ...
            style={{ zIndex: 20 }}
            aria-label="Learn more about AI Powered Backtesting"
          >
            <span className="w-2 h-2 rounded-full bg-purple-400 mr-2 animate-pulse" aria-hidden="true"></span>
            AI Powered Backtesting
            <span className="absolute -right-1 -top-1 w-2 h-2 bg-pink-400 rounded-full animate-ping" aria-hidden="true"></span>
          </button>
          ...
          <div className="relative w-20 h-20 mx-auto mt-6 mb-2 md:hidden">
            <img
              ...
              height="80"
            />
            <div className="absolute inset-0 bg-gradient-to-b from-purple-500/10 to-transparent rounded-full" aria-hidden="true"></div>
          </div>
